import { isUndefined, broadcast, merge, decode, is, encode, containsCircularPaths, findCircularPathsIn } from '../utils';
...
const Store = function (name, config) {
	...
	this.config = merge({ storage: 'best', expires: 10 * 365 * 24 * 60 * 60 * 1000 }, config);
